...
namespace Nexusvc\OAuth2\Server\Entity;

use Nexusvc\OAuth2\Server\AbstractServer;
use Nexusvc\OAuth2\Server\Event\SessionOwnerEvent;
...
class SessionEntity
{
     ...
     * Client identifier
     *
     * @var \Nexusvc\OAuth2\Server\Entity\ClientEntity
     */
    protected $client;
     ...
     * Auth code
     *
     * @var \Nexusvc\OAuth2\Server\Entity\AuthCodeEntity
     */
    protected $authCode;
     ...
     * Refresh token
     *
     * @var \Nexusvc\OAuth2\Server\Entity\RefreshTokenEntity
     */
     ...
     *
     * @var \Nexusvc\OAuth2\Server\AuthorizationServer|\Nexusvc\OAuth2\Server\ResourceServer
     */
    protected $server;
     ...
     * Associate a scope
     *
     * @param \Nexusvc\OAuth2\Server\Entity\ScopeEntity $scope
     *
     * @return self
     */
     ...
     *
     * @return \Nexusvc\OAuth2\Server\Entity\ScopeEntity[]
     */
     ...
     *
     * @param  \Nexusvc\OAuth2\Server\Entity\Scope[]
     *
     * @return array
     */
     ...
     *
     * @param \Nexusvc\OAuth2\Server\Entity\AccessTokenEntity $accessToken
     *
     * @return self
     */
     ...
     *
     * @param \Nexusvc\OAuth2\Server\Entity\RefreshTokenEntity $refreshToken
     *
     * @return self
     */
     ...
     *
     * @param \Nexusvc\OAuth2\Server\Entity\ClientEntity $client The client
     *
     * @return self
     */
     ...
     *
     * @return \Nexusvc\OAuth2\Server\Entity\ClientEntity
     */
