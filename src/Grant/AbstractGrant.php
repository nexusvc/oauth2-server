...
namespace Nexusvc\OAuth2\Server\Grant;

use Nexusvc\OAuth2\Server\AuthorizationServer;
use Nexusvc\OAuth2\Server\Entity\ClientEntity;
use Nexusvc\OAuth2\Server\Entity\ScopeEntity;
use Nexusvc\OAuth2\Server\Exception;
...
abstract class AbstractGrant implements GrantTypeInterface
{
     ...
     * AuthServer instance
     *
     * @var \Nexusvc\OAuth2\Server\AuthorizationServer
     */
    protected $server;
     ...
     * @param \Nexusvc\OAuth2\Server\Entity\ClientEntity $client      Client entity
     * @param string|null                               $redirectUri The redirect URI to return the user to
     *
     * @return \Nexusvc\OAuth2\Server\Entity\ScopeEntity[]
     *
     * @throws \Nexusvc\OAuth2\Server\Exception\InvalidScopeException If scope is invalid, or no scopes passed when required
     * @throws
     */
     ...
     *
     * @param  \Nexusvc\OAuth2\Server\Entity\ScopeEntity[]
     *
     * @return array
     */
