...
interface AccessTokenInterface extends StorageInterface
{
     ...
     *
     * @return \Nexusvc\OAuth2\Server\Entity\AccessTokenEntity | null
     */
     ...
     *
     * @param \Nexusvc\OAuth2\Server\Entity\AccessTokenEntity $token The access token
     *
     ...
     *
     * @param \Nexusvc\OAuth2\Server\Entity\AccessTokenEntity $token The access token to delete
     *
     * @return void
     */
